/*
	...
	Visual Studio 6.0 thru Visual Studio 2022 and MingW compatible
...
#define RTL_CONSTANT_STRING(s) { sizeof( s ) - sizeof( (s)[0] ), sizeof( s ) / sizeof(_RTL_CONSTANT_STRING_type_check(s)), _RTL_CONSTANT_STRING_remove_const_macro(s) }
...
typedef struct _NT_CREATE_THREAD_EX_ATTRLIST
{
    ULONG Size;
    ULONG Unknown1;
    ULONG Unknown2;
    ...
    PULONG Unknown7;
    ULONG Unknown8;
} NT_CREATE_THREAD_EX_ATTRLIST, *PNT_CREATE_THREAD_EX_ATTRLIST;
...
NtCreateThreadEx (
    ...
    IN OPTIONAL PNT_CREATE_THREAD_EX_ATTRLIST AttributeList
);
#endif
...
typedef PVOID(NTAPI* PDELAYLOAD_FAILURE_DLL_CALLBACK)(
    IN ULONG NotificationReason,
    IN PDELAYLOAD_INFO DelayloadInfo
	);
...
LdrResolveDelayLoadedAPI(
    ...
    IN OPTIONAL PDELAYLOAD_FAILURE_DLL_CALLBACK FailureDllHook,
	IN OPTIONAL PDELAYLOAD_FAILURE_SYSTEM_ROUTINE FailureSystemHook, // kernel32.DelayLoadFailureHook
